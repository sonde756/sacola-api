...
public class SacolaServiceImpl implements SacolaService {
    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
        ...
        if (sacola.isFechada()) {
            throw new RuntimeException("Esta sacolad esta fechada");
        }
        ...
        if (itensDaSacola.isEmpty()) {
            ...
            if (restauranteAtual.equals(restauranteDoItemParaAdicionar)){
                ...
                throw new RuntimeException("Não é possivel adicionar produtos de restaurantes diferentes. Fecha e sacola ou esvazie.");
            }
        }
    ...
    public Sacola fecharSacola(Long id, int numFormaPagamento) {
        ...
        FormaPagamento formaPagamento =
                numFormaPagamento == 0 ? FormaPagamento.MAQUINETA : FormaPagamento.DINHEIRO;
